...
from neuralens.example import classes, hello, math
...
class ClassesTestCase(TestCase):
    ...
    def test_luminosity(self):
        """Test ``neuralens.example.classes.StefBoltz.luminosity`` method.

        See Also
        --------
        neuralens.example.classes.StefBoltz : Implementation of the
            ``StefBoltz`` class.
...
class HelloTestCase(TestCase):
    ...
    def test_hello_world(self):
        """Test ``neuralens.example.hello.hello_world`` function.

        See Also
        --------
        neuralens.example.hello.hello_world : Implementation of the
...
class MathTestCase(TestCase):
    ...
    def test_add_two_ints(self):
        """Test ``neuralens.example.math.add_two_ints`` function.

        See Also
        --------
        neuralens.example.math.test_add_two_ints : Implementation of the
    ...
    def test_drake_equation(self):
        """Test ``neuralens.example.math.drake_equation`` function.

        See Also
        --------
        neuralens.example.math.drake_equation : Implementation of the
    ...
    def test_mad(self):
        """Test ``neuralens.example.math.mad`` function.

        See Also
        --------
        neuralens.example.math.mad : Implementation of the
            ``mad`` function.
