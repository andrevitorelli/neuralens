...
from neuralens.example.classes import StefBoltz
from neuralens.example.hello import hello_world
...
def call_stefboltz(radius: float, eff_temp: float):
    ...
    See Also
    --------
    neuralens.example.classes.StefBoltz : Implementation of the ``StefBoltz``
        class.
